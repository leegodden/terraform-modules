...
# create public subnet az1 - (the first avaliable zone)
...
# create public subnet az2 - (the second avaliable zone)
...
# resoure to associate public subnet az1 to "public route table"
